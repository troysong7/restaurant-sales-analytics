# Quick-Service Restaurant Operations Analytics
...
- When are customer orders most concentrated throughout the week and day?
- How do the four locations compare in terms of traffic and average order value?
...
- **The Dinner Rush:** The 6:00 PM – 10:00 PM window drove 57% of daily sales, pointing directly to heavy evening staffing needs.
- **Volume vs. Margin:** High-revenue items (Entrees and Wings) yielded lower profit margins compared to supplemental categories (Beverages and Sides).
- **Discount Inefficiency:** Promotional discounts reduced margins without generating a proportionally large spike in transaction volume.

## Business Recommendations
1. **Menu Optimization:** Review pricing structures and ingredient costs for high-volume, low-margin items.
2. **Labor Scheduling:** Align staff headcount tightly with the identified 6–10 PM peak and weekend surges.
3. **Location Strategy:** Investigate operational bottlenecks at lower-traffic locations like Airport Rd.
...
## Disclaimer
This project uses synthetic data created for educational and portfolio purposes. It does not represent the financial performance of any actual restaurant entity.
